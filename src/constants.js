export const NUMBER_OF_BODIES = 7;

export const NUMBER_OF_HEADS = 12;

export const NUMBER_OF_FACES = 9;

export const NUMBER_OF_ACCESSORIES = 6;
...
export const DEFAULT_SKIN_COLOR = SKIN_COLORS[0].color;

export const DEFAULT_CLOTHES_COLOR = CLOTHES_COLORS[0].color;